...
function drawHtmlTable(tab) {
    ...
    for (var i = 0 ; i < maxXCount ; i++) {
         retVal += "<th style=\"background-color: grey;\">"
         if (i < 26) {
             retVal += String.fromCharCode(65 + i);
         } else {
             var first = parseInt(i/26) - 1;
             var sec = i % 26;
             retVal += String.fromCharCode(65 + first);
             retVal += String.fromCharCode(65 + sec);
         }
         retVal += "</th>\n"
    }
    retVal += "</tr>\n"
